...
-- Seed Workflow Steps
-- Category 10 (Laptop): Step 1: Line Manager (Role 2), Step 2: HOD (Role 5, Cost > $500)
INSERT INTO workflow_steps (category_id, step_order, approver_role_id, min_cost_threshold, is_mandatory) VALUES
(10, 1, 2, 0, TRUE),
(10, 2, 5, 500, TRUE),
-- Category 20 (Software License): Step 1: Line Manager (Role 2)
(20, 1, 2, 0, TRUE),
-- Category 30 (Business Cards): Step 1: Line Manager (Role 2)
(30, 1, 2, 0, TRUE)
